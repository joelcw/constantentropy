...
(Move some stuff from the sections below)
...
\begin{itemize}
	...
	For designing studies and taking a lead role in writing up results, particularly on questions \ref{aud} and \ref{evo}. 
	\item Research Assistant (ECR), full-time, 2 years\\Primarily to help with computational aspects of the project, especially for question \ref{change} and in designing a front-end for a diagnostic tool relating to the project's impact.
\end{itemize}
