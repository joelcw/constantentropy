...
2:{
    ...
    OR ((IP-MAT* idoms object) AND (object idoms D) AND (D idoms th[iey]s*|+t[iey]s*|+t[ea]t*|th[ae]t*))
...
3: {
  pronsbj: (IP-MAT* idoms NP-NOM*|NP-SBJ*) AND (NP-NOM*|NP-SBJ* idomsonly PRO*)
    ...
    OR ((IP-MAT* idoms NP-NOM*|NP-SBJ*) AND (NP-NOM*|NP-SBJ* idoms D) AND (D idoms th[iey]s*|+t[iey]s*|+t[ea]t*|th[ae]t*))
